...
<html>
    <head>
        ...
        <script src="../consultas/consulcurso.js"></script>
    </head>
    <body>
        <div class="container">
            <div class="row">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <form class="form-inline my-2 my-lg-0 mb-4" id="searchForm">
                                ...
                                <input type="search" id="search" class="form-control mr-sm-2" placeholder="Buscar curso" aria-label="Buscar">
                                <button type="submit" class="btn btn-success my-2 my-sm-0">Buscar</button>
                            </form>

                            <div id="tabla-cursos" style="display:none;">

...
<html>
    <head>
        ...
        <script src="../consultas/consulalumno.js"></script>
    </head>
    <body>
        <div class="container">
            <div class="row">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <form class="form-inline my-2 my-lg-0 mb-4" id="searchForm">
                                <label>Descripcion del alumno: </label><br>
                                <input type="search" id="search" class="form-control mr-sm-2" placeholder="Buscar alumno" aria-label="Buscar">
